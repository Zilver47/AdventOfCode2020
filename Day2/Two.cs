...
public class Day2Two : IAnswerGenerator
{
    private List<(string Policy, string Password)> _input;

    public Day2Two()
    {
        _input = new List<(string Policy, string Password)>
        {("4-5 t", "ftttttrvts"),
("7-8 k", "kkkkkkkf"),
("4-6 k", "gqjkkk"),
("1-2 t", "rttb"),
...
("6-7 g", "gghggcggg")
    ...
    {
        var firstPosition = policy.MinimalOccurrence;
        var secondPosition = policy.MaximumOccurrence;
        var charFirstPosition = password.Substring(firstPosition - 1, 1);
        var charSecondPosition = string.Empty;
        if (password.Length >= secondPosition){
                charSecondPosition = password.Substring(secondPosition - 1, 1);
        }

        return charFirstPosition == policy.Character.ToString() ^
            charSecondPosition == policy.Character.ToString();
    }
